...
<template>
  ...
  <SectionCover
      ...
      :to="`/projects/centrale-operativa-telecontrol`"
  />
  <SectionCover
            ...
            <div class="space-y-6 xl:space-y-10">
              ...
              <div class="space-y-2 xl:flex xl:items-center xl:justify-between">
                <div class="font-medium text-lg leading-6 space-y-1">
                  ...
                  <p class="hidden lg:block text-base text-gray-700 text-left">
                    {{ person.description }}
                  </p>
                  <p class="lg:hidden text-base text-gray-700 text-left border-b border-gray-700 pt-2 pb-2">
                    {{ person.description }}
                  </p>
                </div>
              ...
              <div class="space-y-2">
                <div class="font-medium text-lg leading-6 space-y-1 text-center">
                  <NuxtLink :to="`/articles/${a.slug}`" class="text-gray-500 hover:text-gray-700">
                    ...
                    <h3 v-if="a.titleHtml" class="max-w-lg text-xl text-black sm:max-w-3xl mx-auto" v-html="a.titleHtml" />
